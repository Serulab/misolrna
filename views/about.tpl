...
<div class="well">
  ...
  <h2>About Us</h2>     
    ...
    <h2>Participating groups</h2>
         <ul>
       <li><a href="http://www.inta.gov.ar/biotec/investiga/vegetal_gefeia02_en.htm">Structural and Functional Genomics to Solanaceaes Genetic Resources group. - Instituto de Biotecnología - INTA - Argentina</a></li>
  <li><a href="http://www.inta.gov.ar/biotec/investiga/vegetal_bmihp01_en.htm">Plant-Virus interaction, molecular mechanism of resistance on model systems - Instituto de Biotecnología - INTA - Argentina</a></li>
